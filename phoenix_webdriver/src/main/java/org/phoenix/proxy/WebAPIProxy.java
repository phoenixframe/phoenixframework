...
public class WebAPIProxy implements InvocationHandler {
	...
	public WebAPIProxy(Object target,LinkedList<UnitLogBean> unitLog,CaseLogBean caseLogBean) {
		this.target = target;
	...
	public Object invoke(Object proxy, Method method, Object[] args) {
		...
		try{
			...
			if(SystemInfo.isWindows()){
				...
				picPath = ScreenShot.TakeScreenshot((caseLogBean.getAttachPath()==null?System.getProperty("user.dir")+"\\phoenix":caseLogBean.getAttachPath())+"\\screenshot\\"+picName+".jpg");

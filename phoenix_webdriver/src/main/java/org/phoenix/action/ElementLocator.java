...
public class ElementLocator {
	...
	public SelenideElement webElement(String locator, LocatorType locatorType){
		switch (locatorType) {
	...
	public By by(String locator, LocatorType locatorType){
		switch (locatorType) {
	...
	public ElementsCollection webElements(String locator, LocatorType locatorType){
		switch (locatorType) {
			case CSS:  return $$(locator);
			case NAME: return $$(By.name(locator));
			case XPATH: return $$(By.xpath(locator));

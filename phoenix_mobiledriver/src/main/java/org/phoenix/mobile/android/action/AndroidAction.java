...
public interface AndroidAction {
	 ...
	 * @param text
	 */
	void appElementSetText(String text);
	/**
	 * 清空app的元素值
	 */
	void appElementClear();
	/**
	 * 判断该元素是否已显示
	 * @return
	 */
	boolean appElementIsDisplayed();
	/**
	 * 判断元素是否可用
	 * @return
	 */
	boolean appElementIsEnabled();
	/**
	 * 判断元素是否已被选择
	 * @return
	 */
	boolean appElementIsSelected();
	/**
	 * 对app元素作单击操作
	 */
	void appElementClick();
	/**
	 * 对元素模拟双击
	 */
	void appElementDoubleClick();
	/**
	 * 对一个元素做长按操作
	 */
	void appElementClickAndHold();
	/**
	 * 获取元素的一个集合
	 * @return
	 */
	List<WebElement> getAppElements();
	/**
	 * 获取元素的标签名称
	 * @return
	 */
	String getAppElementTagName();
	/**
	 * 获取元素属性值
	 * @param name
	 * @return
	 */
	String getAppAttribute(String name);
	/**
	 * 如果有css属性，则获取元素的css值
	 * @param propertyName
	 * @return
	 */
	String getAppCssValue(String propertyName);
	/**
	 * 获取元素的Point对象
	 * @return
	 */

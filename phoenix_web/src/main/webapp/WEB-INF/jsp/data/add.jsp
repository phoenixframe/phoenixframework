...
<sf:form method="post" action="${caseBean.id }" modelAttribute="dataDTO" id="addForm">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">所属用例</td>
        <td>
        	<sf:input type="hidden" path="caseId" id="caseId" value="${caseBean.id }"/>${caseBean.caseName }
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">数据标识</td>
        <td><sf:input path="dataName"/><sf:errors path="dataName"/></td>
    </tr>
    <tr>
        <td class="tableleft">数据内容</td>   
        <td><sf:input path="dataContent"/><sf:errors path="dataContent"/></td>
    </tr>   
    <tr>

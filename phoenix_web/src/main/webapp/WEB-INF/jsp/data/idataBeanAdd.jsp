...
<sf:form method="post" action="${bid }" modelAttribute="interfaceDataBean">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">所属数据批次</td>
        <td>
        	${bid }
        </td>
    </tr>
    ...
    <tr>
        <td width="10%" class="tableleft">参数值</td>
...
<script type="text/javascript">
    $(function () {       
		$('#backid').click(function(){
			...
			window.location.href=basePath+"/data/INTERFACE_CASE/iblist/"+${bid };
		 });

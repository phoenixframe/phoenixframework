 ...
 * @author mengfeiyang
 */
public class WebTableService extends ActionProxy{
	...
	public LinkedList<UnitLogBean> run(CaseLogBean caseLogBean) {
		...
		//为将要访问的地址设置Host或代理
		HttpClient client = phoenix.interfaceAPI().getHttpClientWithProxy("10.138.65.218", 80, "", "");
		HttpResponse resp = phoenix.interfaceAPI().getResponseByHttpClient(client, "http://dianjing.eapidoc.360.cn/#api-Account-account_getcertlist", "get", null);
		try {
